      ...
      <div className="wrap">
        ...
        <div className="webhook-box reveal">
          <div className="webhook-box-head">
            ...
            <button className="copy-btn" onClick={() => { navigator.clipboard.writeText(webhookSnippet); setCopied(true); setTimeout(() => setCopied(false), 2000); }}>
        ...
        <div className="support-cols reveal">
          ...
          <div>
            ...
            <div className="contacts-panel">
              <h4>Direct Omni-Channel Contacts</h4>
