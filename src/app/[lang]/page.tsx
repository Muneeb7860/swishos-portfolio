      ...
      <section className="hero" style={{ padding: '60px 0 60px' }}>
        <div className="wrap" style={{ maxWidth: '1240px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 style={{
            ...
            {dict.hero.title1} <br />
            <span style={{ color: 'var(--txt)', fontWeight: 900 }}>
              {dict.hero.title2}
            </span>
          </h1>
      ...
      <section style={{ padding: '60px 0' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <span style={{ fontSize: '11px', fontWeight: 800, color: 'var(--badge-txt)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '32px', alignItems: 'stretch' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <span style={{ fontSize: '11px', fontWeight: 800, color: 'var(--badge-txt)', textTransform: 'uppercase', letterSpacing: '0.06em', background: 'var(--badge-bg)', padding: '4px 10px', borderRadius: '4px', border: '1px solid var(--card-border)' }}>
                  FOR CISOS & SECURITY LEADERSHIP
                </span>
                <span style={{ fontSize: '13px', fontWeight: 800, color: 'var(--txt)' }}>$7,500 – $12,500</span>
              </div>
              <h3 style={{ fontSize: '22px', fontWeight: 800, color: 'var(--txt)', marginBottom: '12px' }}>AI Agent Security Audit</h3>
              <p style={{ fontSize: '14px', color: 'var(--muted-2)', lineHeight: 1.6, marginBottom: '20px' }}>
                {isAr
